class SharksController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @shark.save
        format.html { redirect_to @shark, notice: 'Order was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @shark.update(shark_params)
        format.html { redirect_to @shark, notice: 'Order was successfully updated.' }
  ...
  def destroy
    @shark.destroy
    respond_to do |format|
      format.html { redirect_to sharks_url, notice: 'Order was successfully destroyed.' }
